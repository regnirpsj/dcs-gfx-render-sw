...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  hugh/render/software/pipeline/flexible/base.cpp                                 */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/
      ...
      namespace pipeline {
        ...
        namespace flexible {
          ...
          base::base()
            : pipeline::base()
          {
            TRACE("hugh::render::software::pipeline::flexible::base::base");
          }
          ...
          {
            TRACE("hugh::render::software::pipeline::flexible::base::process(" +
            ...
            default:
              {
                ...
                ostr << "<hugh::render::software::pipeline::flexible::base::process>: "
...
#if 0
            {
              std::cout << support::trace::prefix()
                // << "hugh::render::software::pipeline::flexible::base::process: "
                        << (p.indices.empty() ? "!" : " ") << "idx "
                        << p.topology
                        << "  \t"
                        << lstats
          ...
          {
            TRACE("hugh::render::software::pipeline::flexible::base::transform");
          ...
          {
            TRACE("hugh::render::software::pipeline::flexible::base::shade");
