...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  hugh/render/software/pipeline/fixed/direct3d.cpp                                */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/
      ...
      namespace pipeline {
        ...
        namespace fixed {
          ...
          direct3d::direct3d()
            : base()
          {
            TRACE("hugh::render::software::pipeline::fixed::direct3d::direct3d");
          }
          ...
          {
            TRACE("hugh::render::software::pipeline::fixed::direct3d::ndc_to_window");
