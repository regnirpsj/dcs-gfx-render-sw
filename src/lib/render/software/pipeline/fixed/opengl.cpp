...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  hugh/render/software/pipeline/fixed/opengl.cpp                                */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/
      ...
      namespace pipeline {
        ...
        namespace fixed {
          ...
          opengl::opengl()
            : base()
          {
            TRACE("hugh::render::software::pipeline::fixed::opengl::opengl");
          }
          ...
          {
            TRACE("hugh::render::software::pipeline::fixed::opengl::ndc_to_window");
