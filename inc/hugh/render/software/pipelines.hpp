...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  hugh/render/software/pipelines.hpp                                              */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/

#if !defined(HUGH_RENDER_SOFTWARE_PIPELINES_HPP)

#define HUGH_RENDER_SOFTWARE_PIPELINES_HPP
...
#endif // #if !defined(HUGH_RENDER_SOFTWARE_PIPELINES_HPP)
